...
| <a name="input_note"></a> [note](#input\_note) | Note/comment text used in generated files. | `string` | `"This file is generated. Manage it through the upstream YAML-driven workflow instead of editing it directly."` | no |
